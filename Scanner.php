...
<body>
        ...
        if(isset($_POST['btn_Scanner']))
        {
            if(isset($_POST['subject_code']))
            {
                ...
                if(mysqli_num_rows($result3)==1)
                {
                    ...
                    {
                        echo '<script type ="text/JavaScript">';  
							echo 'swal({title: "Scan proper Qr!",
    ...
    <div class ="right">
        <form method="post">
            ...
            <button  name="btn_Scanner" class="buttonlogout">Submit <i class='fas fa-power-off'></i></button>
        </form>
    </div>
    ...
    <script>
            ...
            var scanner = new Instascan.Scanner({  //Object create
                video : video  //property set
            });
